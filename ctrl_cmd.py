...
class RobotControl:
    def __init__(self, arm_trajectory, forward_speed, strafe_speed, rotate_speed, height_speed, stop_step_num, speed_increment, delta_joint):
    ...
    def arm_position_publish(self,left_arm_pose, right_arm_pose):
        x=1
    ...
    def run(self):
        ...
        print("6-0: Adjust left arm joints 1-5 negatively")
